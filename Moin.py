    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 120:
                ...
                full_command = f"./Moin {target} {port} {time} 100"
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY key ACCESS:- @SIDIKI_MUSTAFA_47")
...
𝐁𝐮𝐲 𝐟𝐫𝐨𝐦 :- @SIDIKI_MUSTAFA_47
Official Channel :- https://t.me/+XMvgTnZbPz01ZWI1
'''
...
3. MAKE SURE YOU JOINED  https://t.me/+XMvgTnZbPz01ZWI1 OTHERWISE NOT WORK
